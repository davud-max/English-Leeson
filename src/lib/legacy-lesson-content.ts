...
export const LEGACY_LESSON_CONTENT: Record<number, LegacyLessonContent> = {
  "9": {
    "order": 9,
...
export function getLegacyLessonContent(order: number): LegacyLessonContent | null {
  return LEGACY_LESSON_CONTENT[order] ?? null
}
