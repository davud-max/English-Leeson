// Simplified Enhanced Slide Demo - Direct Route
'use client'
...
export default function SimpleTestPage() {
  ...
  const FramerStyleDemo = () => (
    <div className="bg-gradient-to-br from-purple-600 to-pink-600 min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/20 backdrop-blur-xl rounded-3xl p-8 mb-8 animate-fadeIn">
          <h1 className="text-4xl font-bold text-white text-center mb-4 animate-slideDown">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-white/20 backdrop-blur-xl rounded-2xl p-6 transform hover:scale-105 transition-all duration-300">
            <h2 className="text-2xl font-bold text-white mb-4 text-center animate-slideLeft">
              🎭 Dynamic Counting
            </h2>
            <div className="bg-gradient-to-br from-amber-500/40 to-orange-500/40 rounded-2xl p-6 animate-pulse-slow">
          ...
          <div className="bg-white/20 backdrop-blur-xl rounded-2xl p-6 animate-slideRight">
