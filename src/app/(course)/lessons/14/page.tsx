      ...
      <div className="fixed inset-x-0 bottom-0 z-50 border-t-2 border-amber-700 bg-white shadow-[0_-6px_16px_rgba(0,0,0,0.12)]">
        <div className="max-w-4xl mx-auto px-3 py-3">
          <div className="grid grid-cols-3 items-center gap-2 text-sm">
            <Link href="/lessons/13" className="justify-self-start rounded-md border border-stone-300 px-3 py-2 font-medium text-stone-700 hover:bg-stone-100">
              ← Prev Lesson
            </Link>
            ...
            <Link href="/lessons/15" className="justify-self-end rounded-md border border-stone-300 px-3 py-2 font-medium text-stone-700 hover:bg-stone-100">
              Next Lesson →
            </Link>
          </div>
        </div>
