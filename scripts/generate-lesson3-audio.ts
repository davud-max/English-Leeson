// Generate audio for Lesson 3 using Google TTS
...
export async function generateLesson3Audio() {
  console.log('🎬 Starting audio generation for Lesson 3...');
  
  try {
    for (let i = 0; i < LESSON_3_TEXTS.length; i++) {
      await ttsService.generateWithGoogleTTS(LESSON_3_TEXTS[i], `slide${i + 1}.mp3`);
      console.log(`✅ Generated slide ${i + 1}/${LESSON_3_TEXTS.length}`);
    }
    
    console.log('🎉 All slides generated successfully for Lesson 3!');
